...
class GenerateSound:
    ...
    def generateSound(self, text, store_path, sc=255, ns=0.6, nsw=0.688, ls=1.2, ):
        result = self.vits(text, 0, sc, self.ns, self.nsw, self.ls, self.device, self.hps_ms, self.net_g_ms)
